...
type SidebarProps = {
  ...
  handleRoomChange: (roomId: string, roomAdmin: string) => void
...
export default function Sidebar({
  ...
  const fetchuserlogout = async () => {
    try {
      const response = await axios.get("http://localhost:8000/userlogout", { withCredentials: true });
  ...
  return (
    <div className="w-64 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 flex flex-col">
      ...
      <Tabs defaultValue="rooms" className="flex-1 flex flex-col">
        ...
        <TabsContent value="rooms" className="flex-1 flex flex-col p-2">
            ...
            <div className="space-y-1 px-1">
              {rooms.map((room) => (
                ...
                <Button
                  ...
                  onClick={() => handleRoomChange(room._id, room.admin)}
                >
                  # {room.roomName}
                </Button>
                
                <Button className="ml-auto p-1 h-8 w-8 flex items-center justify-center" onClick={()=>handleRoomDelete(room._id, room.admin)}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Avatar className="h-8 w-8">
                <AvatarFallback>{loginUser.username.substring(0, 2).toUpperCase()}</AvatarFallback>
              </Avatar>
              <div className="space-y-1">
                <p className="text-sm font-medium leading-none">{loginUser.username}</p>
                  ...
                  <div className="space-y-4">
                        ...
                        {isEditingProfile ? (
                          <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                              ...
                              <Input id="userId" value={loginUser.id} disabled className="opacity-50" />
                    ...
                    {isChangingPassword && (
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2 pt-2">
                            <Button variant="default" className="flex-1" onClick={handleSavePassword}>
                              <Save className="mr-2 h-4 w-4" />
                              Save
                            </Button>
                    ...
                    {!isEditingProfile && !isChangingPassword && (
                      <div className="space-y-2">
                        ...
                        <Button variant="outline" className="w-full justify-start" size="sm" onClick={fetchuserlogout}>
